...
| 20 | `TcxFreezeSetPoint` min/max bounds (`_FREEZE_SP_MIN/MAX_F/_C`) hardcoded | Shadow bounds field presence not confirmed — same caveat as delta #2 (heater bounds) |
